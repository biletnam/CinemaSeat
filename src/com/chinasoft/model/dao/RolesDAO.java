...
import com.chinasoft.model.entity.Roles;
 ...
 * 
 * @see com.chinasoft.model.entity.Roles
...
public class RolesDAO {
	...
	public static final String _RPOWER = "RPower";
	...
	public List findByExample(Roles instance) {
		...
		try {
			List results = getCurrentSession()
					.createCriteria("com.chinasoft.model.entity.Roles")
	...
	public List findByRPower(Object RPower) {
		return findByProperty(_RPOWER, RPower);
	}
