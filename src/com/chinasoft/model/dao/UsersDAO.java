 ...
 * 
 * @see com.chinasoft.model.entity.Users
 * @author MyEclipse Persistence Tools
 */
public class UsersDAO {
	private static final Logger log = LoggerFactory.getLogger(UsersDAO.class);
	// property constants
	public static final String _AID = "AId";
	public static final String _RID = "RId";
	public static final String _UMONEY = "UMoney";
	...
	public Users findById(java.lang.String id) {
		...
		try {
			Users instance = (Users) getCurrentSession().get(
					"com.chinasoft.model.entity.Users", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Users instance) {
		...
		try {
			List results = getCurrentSession()
					.createCriteria("com.chinasoft.model.entity.Users")
	...
	public List findByAId(Object AId) {
		return findByProperty(_AID, AId);
	}
	...
	public List findByUMoney(Object UMoney) {
		return findByProperty(_UMONEY, UMoney);
	}
	...
	{
		String sql = "select a.RPower from Roles a, Accounts b ,Users c where b.AId=c.AId and a.RId = c.RId and b.AId=?";
		try {
			Query query = getCurrentSession().createQuery(sql).setString(0, aid);
