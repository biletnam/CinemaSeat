...
<html>
  <head>
    <title>My JSP 'chooseseat.jsp' starting page</title>
  ...
  <body>
  		<!-- 座位状态隐藏域 -->
  			<input type="hidden" value='<s:property value="seat.seState"/>'  id="seatstate">
  		<!-- ---------------- -->
		<header class="header">
						...
						<div class="intro intro--shown">
							<div class="intro__side">
								<h2 class="intro__title">
									...
									<span class="intro__down">影片 <span class="intro__partial"><em>：</em><s:property value="movie.MName"/></span></span>
								</h2>
							</div>
							<div class="intro__side">
		...
		<div class="plan">
			...
			<ul class="legend">
				...
				<li class="legend__item legend__item--reserved">已选</li>
				<li class="legend__item legend__item--selected">选中</li>
			</ul>
			<button class="action action--buy" onclick="buyticket();">出票</button>
		</div><!-- /plan -->
		...
		<script src="js/seatJS.js"></script>
	</body>
</html>
